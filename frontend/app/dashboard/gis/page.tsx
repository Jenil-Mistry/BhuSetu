          ...
          {selectedParcel ? (
            <div className="rounded-2xl bg-white p-6 border border-slate-200 shadow-xs space-y-4">
              ...
              <div className="pt-3 border-t border-slate-100 flex flex-col gap-2">
                ...
                <button
                  onClick={() => setUploadSuccess(`Centering viewport on Parcel ${selectedParcel.khasraNo} (${selectedParcel.village}). Coordinates: [${selectedParcel.coordinates[0][0]}, ${selectedParcel.coordinates[0][1]}]`)}
                  className="w-full py-2.5 rounded-xl border-2 border-slate-300 hover:bg-slate-50 text-xs sm:text-sm font-bold text-slate-800 transition-colors cursor-pointer"
                >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-xs p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl border border-slate-200 animate-in fade-in zoom-in-95 duration-150">
            ...
            <div className="flex justify-end space-x-2 pt-4">
              ...
              <button
                onClick={() => {
                  setUploadSuccess('KML alignment uploaded and parsed to PostGIS geodetic vector table successfully.');
                  setIsUploadModalOpen(false);
                }}
                className="px-5 py-2.5 rounded-xl bg-[#166534] text-white font-bold hover:bg-[#12542a] text-sm shadow-sm cursor-pointer"
              >
                Upload & Process
              </button>
            </div>
