              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                  ...
                  <div className="flex sm:flex-col items-end justify-between sm:justify-start gap-2 shrink-0">
                    ...
                    <button
                      onClick={() => alert(`Simulating download of official Gazette PDF: ${notif.gazette_number}`)}
                      className="flex items-center space-x-1.5 px-3 py-1.5 rounded-xl border border-slate-200 hover:bg-slate-50 text-xs font-bold text-[#0F2E53] shadow-xs"
                    >
