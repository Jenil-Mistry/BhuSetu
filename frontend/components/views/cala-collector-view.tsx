    ...
    <div className="space-y-6">
      {actionToast && (
        <div className="flex items-center justify-between p-4 bg-emerald-50 border-2 border-emerald-300 rounded-2xl text-sm font-bold text-[#166534] shadow-sm animate-in fade-in">
          ...
          <button onClick={() => setActionToast(null)} className="text-emerald-700 hover:text-emerald-950">
            <X className="h-4 w-4" />
          </button>
        </div>
      )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-xs p-4">
          <div className="w-full max-w-xl rounded-2xl bg-white p-6 shadow-2xl space-y-4">
            ...
            <div className="flex justify-end space-x-3 pt-2">
              <button
                onClick={() => {
                  setActionToast('Official Section 19 Gazette Draft PDF downloaded.');
                  setIsPdfModalOpen(false);
                }}
                className="flex items-center space-x-2 px-5 py-2.5 rounded-xl text-sm font-bold text-white bg-[#0F2E53] hover:bg-[#0a203a] shadow-sm cursor-pointer"
              >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-xs p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl space-y-4">
            ...
            <div className="flex justify-end space-x-3 pt-2">
              ...
              <button
                onClick={() => {
                  setActionToast(`Re-verification order dispatched to ${activeCase.patwariName}. Measurement sheet queued for re-survey.`);
                  setIsReverifyModalOpen(false);
                }}
                className="px-5 py-2.5 rounded-xl bg-rose-600 hover:bg-rose-700 text-white font-bold text-sm shadow-sm cursor-pointer"
              >
