          ...
          <button
            onClick={() => {
              ...
              setTimeout(() => {
                ...
                alert('Statutory Cabinet Land Acquisition Report (PDF & CSV) generated successfully!');
              }, 1200);
            }}
            disabled={isGeneratingReport}
            className="flex items-center space-x-2 px-4 py-2 rounded-xl bg-white text-slate-700 hover:bg-slate-50 text-xs font-bold shadow-xs border border-slate-200 transition-colors disabled:opacity-50"
          >
