                ...
                >
                  ...
                  <div className="mt-3 pt-2 border-t border-slate-200/60 flex items-center justify-between">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        alert(`Opening GPS Turn-by-Turn Navigation to Khasra ${item.khasraNo}, ${item.village}`);
                      }}
                      className="inline-flex items-center space-x-1 text-xs font-semibold text-[#166534] hover:underline"
                    >
